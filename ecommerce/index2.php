...
<div class="container">
    ...
    ?>
        ...
        <?php }else if($n_product==2 || $n_product==3){ ?>
                <div class="col-md-3 product-left">
                <?php
                include("view/products/product.php");
                $n_product=$n_product+1;
        ...
        <?php } ?>
    <?php
    if($n_product==2 || $n_product==3 || $n_product==4){ echo "</div>";}
    }
    ?>
        </div>
	</div>
      ...
      <center><nav>
        <ul class="pagination">
          <?php for($i=1;$i<=$total_paginas;$i++){ 
           if($i==$pagina){ ?>    
              <li class="active"><a href="?pagina=<?php echo $i; ?>" disabled><?php echo $i; ?> <span class="sr-only">(current)</span></a></li>
          <?php }else{ ?>
