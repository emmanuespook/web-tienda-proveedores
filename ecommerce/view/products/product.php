	...
	<div class="product-main simpleCart_shelfItem">
		<a href="view/products/show.php?id=<?php echo $row['id']; ?>" class="mask">

			<img class="img-responsive zoom-img" src="view/products/image/<?php echo $row['id'].$row['extension']; ?>" alt="" />
		</a>
