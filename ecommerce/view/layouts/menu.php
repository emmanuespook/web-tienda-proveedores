...
include('config/db.php');
	...
	$sec="SELECT * FROM subcategoria WHERE id_categoria=:id_cat ORDER BY name DESC";
			...
			<div class="header">
				...
				<div class="top-nav">
					<ul class="memenu skyblue">
						...
						<li class="grid"><a href="view/products/?busqueda=<?php echo $res['name']; ?>
							"><?php echo $res['name']; ?></a>
							<div class="mepanel">
								<div class="row">
									<?php 
									...
									<div class="col1 me-one">
										...
										<ul>
											...
											while($r=$co->fetch()){ 
											?>
											<li><a href="view/products/?busqueda=<?php echo $r['name']; ?>"><?php echo $r['name']; ?></a></li>
											<?php } ?>
										</ul>
									</div>
									<?php } ?>
