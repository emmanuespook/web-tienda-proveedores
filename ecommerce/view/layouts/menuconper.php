			...
			<div class="header">
				...
				<div class="top-nav">
					<ul class="memenu skyblue">
						<li class="active"><a href="../products">Inicio</a></li>
						<?php while($res=$conn->fetch()){ ?>
						<li class="grid"><a href="../products/?busqueda=<?php echo $res['name']; ?>
							"><?php echo $res['name']; ?></a>
							<div class="mepanel">
								<div class="row">
									<?php 
									...
									<div class="col1 me-one">
										...
										<ul>
											...
											while($r=$co->fetch()){ 
											?>
											<li><a href="../products/?busqueda=<?php echo $r['name']; ?>"><?php echo $r['name']; ?></a></li>
											<?php } ?>
										</ul>
									</div>
									<?php } ?>
